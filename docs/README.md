...
![HEKTEK City Banner](./assets/BANER-docs-FINAL.png)
...
[![Release v6.5.0](https://img.shields.io/badge/🚀_Release-v6.5.0_Phoenix_Recovery-BB1111?style=for-the-badge&labelColor=000000)](./releases/v6.5.0-liza-recovery.md)
...
[![Docs](https://img.shields.io/badge/📚_Technical_Deep_Dive-success?style=for-the-badge&labelColor=000000)](./README.md)
...
[🎮 **Enter the City**](https://hektek-city.vercel.app/) • [🧠 **AI Architecture**](./architecture/SYSTEM_DIAGRAMS.md) • [🧾 **Blog & Updates**](./blog/)
...
![Liza Cockpit UI Mockup](./assets/cockpit-console-FINAL.png)
...
*   **[Technical Deep Dive](./README.md)**: The engineer's guide to HekTek City.
*   **[LIZA Specification](./features/Liza/LIZA-FEATURE.md)**: How the agent works.
*   **[Blog Publishing Protocol](./blog/PUBLISHING_WORKFLOW.md)**: The R2 workflow.
